  ...
  return (
    <div>
      ...
      <div className="dark:text-[#86909c]">
        总共发布了：<span className="text-primary">{data.total}</span> 篇文章
      </div>
      <div className="dark:text-[#86909c]">
        总字数约：<span className="text-primary">{(data.wordCount / 1000).toFixed(2)}</span> K
      </div>
    </div>
  );
};
    ...
    <>
      ...
      <div className="">
        <h3 className="flex justify-center items-center text-2xl mb-3">
          <Image src={archiving.src} alt="归档" width={36} height={36} className="mr-3" /> 文章归纳
        </h3>
